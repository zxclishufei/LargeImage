...
public class LargeImageView extends UpdateView implements IPhotoView, ImageManager.OnImageLoadListenner {
    ...
    public HashMap<String, Bitmap> mDimensionBitMap = new HashMap<String, Bitmap>();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (ImageManager.DrawData data : drawData) {
            ...
            if(drawData.size() == 1)
            {
                if(mImageViewHeight > drawRect.bottom)
                {
                    int surplusHeight = mImageViewHeight - drawRect.bottom;
                    drawRect.top = (int)surplusHeight / 2;
                }
            }
